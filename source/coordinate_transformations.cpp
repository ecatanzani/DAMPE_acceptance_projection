...
void from_satellite_to_celestial(Float_t ra[],Float_t dec[],double vectorin[],AtPolarVect &vector_out) {
  ...
  AtVect_To_AtPolarVect(tmp_vector_out,vector_out);
    ...
    */
    /*
    Double_t norm = TMath::Sqrt( TMath::Power(tmp_vector_out[0],2) + TMath::Power(tmp_vector_out[1],2) + TMath::Power(tmp_vector_out[2],2) );
    
    cout<<"\n\n normalization: "<<norm<<endl;
     */
    
    /*
    Double_t cond,ps_xy,ps_xz,ps_yz;
    
    ps_xy=ux1[0]*uy1[0]+ux1[1]*uy1[1]+ux1[2]*uy1[2];
    ps_xz=ux1[0]*uz1[0]+ux1[1]*uz1[1]+ux1[2]*uz1[2];
    ps_yz=uy1[0]*uz1[0]+uy1[1]*uz1[1]+uy1[2]*uz1[2];
    
    cond = vectorin[0]*vectorin[1]*ps_xy+vectorin[0]*vectorin[2]*ps_xz+vectorin[1]*vectorin[2]*ps_yz;
    cout<<"\n --> cond "<<cond<<endl;
    */
